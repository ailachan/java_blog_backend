...
public class PhotoUtils {
    ...
    private static File jpegFile = new File("C:\\Users\\aila\\Pictures\\77041910_p0.png");
    ...
    public static Map<String, Object> photoInformation(MultipartFile photo) {
        ...
        try {
            ...
            //获取上传的图片格式不是jpeg和png格式时,默认的元数据信息(默认基于jpegFile图片的元数据)
